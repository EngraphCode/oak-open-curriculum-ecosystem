 ...
 *   once (MCP-511): it is this resource's own metadata URL (RFC 9728 §3.1) and
 *   the form that survives a path-scoped edge; the unqualified form also
 *   serves but describes the root, not `/mcp`.
 */
