 ...
 *
 * This is a workspace-local copy of the same validator in `@oaknational/agent-tools`;
 * per `consolidate-at-third-consumer`, the shared package is extracted only at a
 * third consumer, not by cross-importing dev tooling into this app.
 *
