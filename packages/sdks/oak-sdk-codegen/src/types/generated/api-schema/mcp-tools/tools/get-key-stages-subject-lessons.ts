...
export const toolMcpFlatInputSchema = z.strictObject({ keyStage: z.enum(["ks1", "ks2", "ks3", "ks4"] as const).describe("Key stage slug to filter by, e.g. 'ks2' - note that casing is important here, and should be lowercase").meta({ examples: ["ks1"] }), subject: z.enum(["art", "citizenship", "computing", "cooking-nutrition", "design-technology", "english", "french", "geography", "german", "history", "maths", "music", "physical-education", "religious-education", "rshe-pshe", "science", "spanish"] as const).describe("Subject slug to filter by, e.g. 'english' - note that casing is important here, and should be lowercase").meta({ examples: ["english"] }), unit: z.string().describe("Optional unit slug to additionally filter by").meta({ examples: ["word-class"] }).optional(), offset: z.number().describe("Offset applied to lessons within each unit (not to the unit list).").meta({ examples: [0] }).optional(), limit: z.number().describe("Limit the number of lessons returned per unit. Units with zero lessons after limiting are omitted.").meta({ examples: [10] }).optional() });
export type ToolInputSchema = z.infer<typeof toolZodSchema>;
const toolArgsDescription = 'Invalid request parameters. Please match the following schema:\nSchema: {"type":"object","properties":{"keyStage":{"type":"string","description":"Key stage slug to filter by, e.g. \'ks2\' - note that casing is important here, and should be lowercase","examples":["ks1"],"enum":["ks1","ks2","ks3","ks4"]},"subject":{"type":"string","description":"Subject slug to filter by, e.g. \'english\' - note that casing is important here, and should be lowercase","examples":["english"],"enum":["art","citizenship","computing","cooking-nutrition","design-technology","english","french","geography","german","history","maths","music","physical-education","religious-education","rshe-pshe","science","spanish"]},"unit":{"type":"string","description":"Optional unit slug to additionally filter by","examples":["word-class"]},"offset":{"type":"number","description":"Offset applied to lessons within each unit (not to the unit list).","default":0,"examples":[0]},"limit":{"type":"number","description":"Limit the number of lessons returned per unit. Units with zero lessons after limiting are omitted.","default":10,"examples":[10]}},"additionalProperties":false,"required":["keyStage","subject"]}\nRequired: keyStage, subject';
