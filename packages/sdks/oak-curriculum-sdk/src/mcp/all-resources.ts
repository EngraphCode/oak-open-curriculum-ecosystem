 ...
 * resources first, then the curriculum model, the two curriculum graphs, and
 ...
 *
 * Prior knowledge has no whole-corpus resource form: it is served by the
 * anchored `get-prior-knowledge-graph` tool (G1b).
 */
