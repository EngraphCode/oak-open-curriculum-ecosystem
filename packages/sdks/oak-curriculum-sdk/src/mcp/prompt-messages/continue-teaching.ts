...
5. Build the lesson. Continue with the lesson-planning prompt workflow for the resolved next topic and ${yearGroup} rather than restating it here — planning substance stays in lesson-planning. Carry the readiness list and the misconceptions from steps 3-4 into that plan, attribution intact.
