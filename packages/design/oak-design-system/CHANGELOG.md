...
- **Accordion selectors scope to direct children** (`.oak-accordion > summary`, including `[open]`, `::after`, and the reduced-motion rule) — descendant scope broke any `<details>` nested inside the body.
