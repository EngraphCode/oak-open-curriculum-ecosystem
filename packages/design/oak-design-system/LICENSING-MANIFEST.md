...
| 3   | System records                    | `README.md`, `DECISIONS.md`, `CHANGELOG.md`, `KNOWN-ISSUES.md`, `LICENCES.md`                                                                                                        | Oak-authored in this repo; MIT — code and repo-authored prose alike (owner ruling 2026-08-02: repo-authored docs MIT; Oak material published on Oak surfaces other than this repo or its apps OGL; README §Licence)       | **Track**                                                                                                                                                                                                                                                          |
| 4   | Voice toolkit text                | `brand_voice.txt`                                                                                                                                                                    | © Oak National Academy under OGL v3.0 (text extraction of the Oak-published brand voice toolkit v2.0 — published on an Oak surface other than this repo or its apps; owner ruling 2026-08-02)                             | **Track** (tracking resolved by the 2026-07-19 owner ruling; licence resolved by the 2026-08-02 provenance ruling)                                                                                                                                                 |
