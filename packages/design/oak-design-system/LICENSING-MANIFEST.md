...
| 3   | System records                    | `README.md`, `DECISIONS.md`, `CHANGELOG.md`, `KNOWN-ISSUES.md`, `LICENCES.md`                                                                                                        | Oak-authored; MIT — code-bearing files and general/technical prose alike (owner ruling 2026-08-02: docs about Oak design OGL, general docs MIT; README §Licence)                                                          | **Track**                                                                                                                                                                                                                                                          |
| 4   | Voice toolkit text                | `brand_voice.txt`                                                                                                                                                                    | © Oak National Academy under OGL v3.0 (docs about Oak design — owner ruling 2026-08-02)                                                                                                                                   | **Track** (RESOLVED by the 2026-07-19 owner ruling)                                                                                                                                                                                                                |
| 5   | Consumption docs                  | `docs/**`                                                                                                                                                                            | © Oak National Academy, MIT (general/technical consumption docs — owner ruling 2026-08-02); referenced libraries MIT                                                                                                      | **Track**                                                                                                                                                                                                                                                          |
