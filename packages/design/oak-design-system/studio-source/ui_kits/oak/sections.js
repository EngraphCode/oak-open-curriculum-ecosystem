    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Button,
            { variant: 'primary', iconRight: 'arrow-right' },
            'Browse subjects',
          ),
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            { style: { display: 'flex', gap: 'var(--space-8)', marginTop: 'var(--space-12)' } },
            ['video', 'quiz', 'worksheet', 'slide-deck'].map((i) =>
              React.createElement(Icon, { key: i, name: i, size: 22 }),
            ),
          ),
        ),
        React.createElement(
...
function SubjectGrid() {
  ...
  return React.createElement(
    ...
    React.createElement(
      'div',
      { style: { display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 'var(--gap-m)' } },
...
function SubjectCard({ subject }) {
  ...
  return React.createElement(
    ...
    React.createElement(
      'span',
      {
        style: { font: 'var(--type-heading-6)', letterSpacing: 'var(--tracking-heading)', flex: 1 },
      },
      s.name,
    ),
...
function FeatureRow({ flip, eyebrow, title, body, cta, bg, accent, children }) {
  const text = React.createElement(
    ...
    React.createElement(
      Tag,
      { color: accent, style: { marginBottom: 'var(--space-16)' } },
      eyebrow,
    ),
    React.createElement(
      'h2',
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(Icon, { name: 'ai', size: 28 }),
        React.createElement(
          'div',
          {
            style: {
...
function PupilFeature() {
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        'div',
        { style: { display: 'flex', gap: 'var(--space-4)', marginBottom: 'var(--space-16)' } },
...
function QuoteBand() {
  return React.createElement(
    'section',
    { style: { background: 'var(--bg-inverted)', padding: 'var(--space-64) var(--space-24)' } },
    React.createElement(
      'figure',
      ...
      React.createElement(
        ...
        React.createElement(
          Button,
          {
            ...
            style: { height: 'var(--size-target-l)' },
          },
          'Sign up',
        ),
      ),
