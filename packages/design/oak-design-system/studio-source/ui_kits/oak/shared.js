  ...
  return React.createElement(
    ...
    iconLeft &&
      React.createElement(Icon, {
        ...
        size: md ? 24 : 20,
        invert: false,
        style: dark ? { filter: 'var(--filter-icon-on-btn-primary)' } : null,
      }),
    React.createElement(
      'span',
      { style: { textDecoration: hover && !dark ? 'underline' : 'none' } },
      children,
    ),
    iconRight &&
      React.createElement(Icon, {
...
function Tag({ children, color = 'lemon', icon, style }) {
  ...
  return React.createElement(
    ...
    icon && React.createElement(Icon, { name: icon, size: 20 }),
    children,
  );
}
...
function Nav({ active = 'Subjects' }) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        'nav',
        { style: { display: 'flex', gap: 'var(--space-20)', flex: 1 } },
        items.map((it) =>
          React.createElement(
            'a',
            {
      ...
      React.createElement(
        Button,
        {
          ...
          size: 'sm',
          iconLeft: 'search',
          style: { height: 'var(--size-target-min)', padding: '0 var(--space-12)' },
        },
        'Search',
      ),
      React.createElement(
        Button,
        {
          variant: 'primary',
          size: 'sm',
          style: { height: 'var(--size-target-min)', padding: '0 var(--space-16)' },
        },
        'Sign in',
      ),
    ),
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { style: { display: 'flex', gap: 'var(--space-12)', marginTop: 'var(--space-20)' } },
