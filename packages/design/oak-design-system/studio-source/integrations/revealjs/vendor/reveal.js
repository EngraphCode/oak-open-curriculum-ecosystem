        ...
        var t = function (e) {
          ...
          c =
            `requestAnimationFrame` in e
              ? function () {
                  var t =
                    arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : { sync: !1 };
        ...
        var n = Object.assign({}, ee, t),
          r = e.map(function (e) {
            ...
            return (
              ...
              { element: e, fit: v(t, a), unfreeze: b(t), freeze: x(t), unsubscribe: y(t) }
            );
          });
        return (c(), r);
      }
  ...
  var ee = class {
      ...
      showPlayOrUnmuteButton() {
        let e = this.failedAudioPlaybackTargets.size,
          ...
          r = `Play media`;
        (n > 0 ? (r = `Play video`) : t > 0 ? (r = `Unmute video`) : e > 0 && (r = `Play audio`),
      ...
      clearMediaPlaybackErrors() {
        (this.resetTemporarilyMutedMedia(),
          ...
          this.mediaPlayButton && this.mediaPlayButton.parentNode && this.mediaPlayButton.remove());
      }
      ...
      jump() {
        ...
        return (
          t ||
            ...
            (t = this.Reveal.location.getIndicesFromHash(e, { oneBasedIndex: !0 }))),
    ...
    oe = class {
      ...
      getAutoAnimateOptions(t, n) {
        ...
        return (
          ...
          t.dataset.autoAnimateDuration && (r.duration = parseFloat(t.dataset.autoAnimateDuration)),
      ...
      getAutoAnimatePairs(e, t) {
        ...
        return (
          ...
          this.findAutoAnimateMatches(n, e, t, r, (e) => e.nodeName + `:::` + e.textContent.trim()),
          this.findAutoAnimateMatches(
            n,
            e,
            t,
      ...
      findAutoAnimateMatches(e, t, n, r, i, a) {
        ...
        ([].slice.call(t.querySelectorAll(r)).forEach((e, t) => {
          ...
          [].slice.call(n.querySelectorAll(r)).forEach((t, n) => {
            ...
            c && e.push({ from: c, to: t, options: a });
          }));
      }
        ...
        ((this.scrollTriggerHeight = r ? a : i),
          ...
          (this.pages = Array.from(
            ...
            ((s += a.autoAnimatePages.reduce(
              ...
              a.pageElement.querySelectorAll(`.scroll-snap-point`).forEach((e) => e.remove()));
            for (let e = 0; e < s + 1; e++) {
            ...
            return (
              r && a.scrollTriggers.length > 0
                ? ((a.pageHeight = i), a.pageElement.style.setProperty(`--page-height`, i + `px`))
              ...
              a.pageElement.style.setProperty(`--page-scroll-padding`, a.scrollPadding + `px`),
              s > 0
                ...
                : ((a.stickyElement.style.position = `relative`),
                  (a.pageElement.style.scrollSnapAlign = a.pageHeight < i ? `center` : `start`)),
              a
            );
          })),
      ...
      activate() {
        ...
        return N(function* () {
          ...
          (r.forEach(function (e, r) {
            ...
            e.Reveal.dispatchEvent({ type: `pdf-ready` }),
      ...
      update(e, t, n = this.Reveal.getCurrentSlide()) {
        ...
        return (
          r.hidden.length &&
            this.Reveal.dispatchEvent({
              type: `fragmenthidden`,
              data: { fragment: r.hidden[0], fragments: r.hidden },
            }),
          r.shown.length &&
            this.Reveal.dispatchEvent({
              type: `fragmentshown`,
              data: { fragment: r.shown[0], fragments: r.shown },
            }),
          r
        );
      }
    ...
    fe = class {
      ...
      onDocumentKeyDown(e) {
        ...
        let i = document.activeElement && document.activeElement.isContentEditable === !0,
          ...
          c =
            !(
              ([32, 37, 38, 39, 40, 63, 78, 80, 191].indexOf(e.keyCode) !== -1 && e.shiftKey) ||
              e.altKey
            ) &&
      ...
      getIndicesFromHash(e = window.location.hash, t = {}) {
        ...
        if (!/^[0-9]*$/.test(r[0]) && n.length) {
          ...
          try {
            ...
            e = (document.getElementById(t) || document.querySelector(`[data-id="${t}"]`)).closest(
              `.slides section`,
            );
          } catch (e) {}
...
` +
    ...
    ye = class {
      ...
      previewMedia(e, t, n) {
        ...
        if (t === `image`) {
          this.state = { previewImage: e, previewFit: n };
          ...
          this.state = { previewVideo: e, previewFit: n };
      ...
      onTouchMove(e) {
        ...
        if (this.touchCaptured) _ && e.preventDefault();
          ...
          if (e.touches.length === 1 && this.touchStartCount !== 2) {
            let i = this.Reveal.availableRoutes({ includeFragments: !0 }),
...
`)
  ...
  function z(a, s) {
    ...
    let l = {},
      ...
      v,
      y,
      b = { hasNavigatedHorizontally: !1, hasNavigatedVertically: !1 },
      x = [],
      S = 1,
      T = { layout: ``, overview: `` },
      D = {},
      ...
      p !== !1 &&
        ...
        setTimeout(() => {
          (D.slides.classList.remove(`no-transition`),
            ...
            Y({ type: `ready`, data: { indexh: h, indexv: _, currentSlide: y } }));
        }, 1));
    }
    function je() {
      let e = f.view === `print`,
    ...
    function He() {
      (window.addEventListener(`resize`, Zt, !1),
        ...
        f.focusBodyOnPageVisibilityChange && document.addEventListener(`visibilitychange`, Qt, !1));
    }
    function Ue() {
      (De.unbind(),
        q.unbind(),
    ...
    function Je(e) {
      Y({
        type: `slidechanged`,
        data: { indexh: h, indexv: _, previousSlide: v, currentSlide: y, origin: e },
      });
    }
    function Ye(t, n) {
      if (f.postMessageEvents && window.parent !== window.self) {
        let r = { namespace: `reveal`, eventName: t, state: Ft() };
    ...
    function X() {
      if (D.wrapper && !R.isActive()) {
        ...
        if (!f.disableLayout) {
          ...
          (Xe(f.width, f.height),
            ...
            S === 1 || L.isActive()
              ...
              : ((D.slides.style.zoom = ``),
                ...
                qe({ layout: `translate(-50%, -50%) scale(` + S + `)` })));
          ...
          r !== S && Y({ type: `resize`, data: { oldScale: r, scale: S, size: n } });
        }
        (Ze(),
    ...
    function Z(e, t, n, r) {
      if (
        Y({
          ...
          data: { indexh: e === void 0 ? h : e, indexv: t === void 0 ? _ : t, origin: r },
        }).defaultPrevented
      )
        return;
      v = y;
    ...
    function ht() {
      (Ue(),
        ...
        f.autoPlayMedia === !1
          ? M.stopEmbeddedContent(y, { unloadIframes: !1 })
          : M.startEmbeddedContent(y),
        B.isActive() && B.layout(),
        Y({ type: `sync` }));
    }
    ...
    function yt(e, n) {
      ...
      if (i) {
        ...
        (e.classList.add(`present`),
          e.removeAttribute(`hidden`),
          e.removeAttribute(`aria-hidden`),
          t || Y({ target: e, type: `visible`, bubbles: !1 }));
    ...
    function Q({ includeFragments: e = !1 } = {}) {
      let t = D.wrapper.querySelectorAll(w),
        ...
        r = { left: h > 0, right: h < t.length - 1, up: _ > 0, down: _ < n.length - 1 };
      if (
        (f.loop &&
      ...
      if (e)
        if (L.isActive())
          ((n = parseInt(e.getAttribute(`data-index-h`), 10)),
            e.getAttribute(`data-index-v`) && (r = parseInt(e.getAttribute(`data-index-v`), 10)));
        else {
          let i = tt(e),
            a = i ? e.parentNode : e,
            o = $();
    ...
    function Ft() {
      let e = Tt();
      return F(
        { indexh: e.h, indexv: e.v, indexf: e.f, paused: lt(), overview: B.isActive() },
        K.getState(),
      );
    }
    function It(e) {
    ...
    function Gt({ skipFragments: e = !1 } = {}) {
      ...
      if (e || z.prev() === !1)
        if (Q().up) Ut({ skipFragments: e });
          ...
          let n;
          if (
            ((n = f.rtl ? t(D.wrapper, w + `.future`).pop() : t(D.wrapper, w + `.past`).pop()),
    ...
    function Jt(e) {
      ...
      if (
        ...
        if (E.test(t.method) === !1) {
          ...
          Ye(`callback`, { method: t.method, result: e });
        } else
    ...
    function Yt(e) {
      ie === `running` &&
        ...
        Y({
          ...
          data: { indexh: h, indexv: _, previousSlide: v, currentSlide: y },
        }));
    }
    function Xt(e) {
