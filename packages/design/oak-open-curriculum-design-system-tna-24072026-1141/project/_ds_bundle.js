...
(() => {
  const __ds_ns = (window.OakNationalAcademyDesignSystem_3ddccf =
    window.OakNationalAcademyDesignSystem_3ddccf || {});
  ...
  try {
    (() => {
      ...
      function oakBtnIconUrl(name) {
        ...
        return s
          ? new URL('assets/icons/' + name + '.svg', s.src).href
      ...
      function OakButton({
        ...
        const base = {
          ...
          font:
            (md
              ? 'var(--weight-semibold) var(--font-size-3)'
              : 'var(--weight-bold) var(--font-size-2)') + '/var(--leading-20) var(--font-sans)',
    ...
    __ds_ns.__errors.push({
      path: 'components/OakButton/OakButton.jsx',
  ...
  try {
    (() => {
      ...
      function OakIcon({ name = 'home', size = 24, invert = false, alt = '', style }) {
    ...
    __ds_ns.__errors.push({
      path: 'components/OakIcon/OakIcon.jsx',
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    (() => {
      ...
      function OakSubjectChip({ subject = 'english', size = 48, icon, bg, style }) {
    ...
    __ds_ns.__errors.push({
      path: 'components/OakSubjectChip/OakSubjectChip.jsx',
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    (() => {
      ...
      function OakTag({ children, color = 'lemon', icon, trailingIcon, style }) {
        const bg =
          {
        ...
        return /*#__PURE__*/ React.createElement(
          'span',
          {
            style: {
              ...
              background: bg,
              border:
                color === 'white' ? 'var(--border-solid-s) solid var(--border-primary)' : 'none',
          ...
          icon ? ic(icon) : null,
          children,
          trailingIcon ? ic(trailingIcon) : null,
        );
      }
    ...
    __ds_ns.__errors.push({
      path: 'components/OakTag/OakTag.jsx',
      error: String((e && e.message) || e),
    });
  }
      ...
      (function (e, t) {
        typeof exports == `object` && typeof module < `u`
          ...
          : typeof define == `function` && define.amd
            ? define([], t)
            : ((e = typeof globalThis < `u` ? globalThis : e || self), (e.Reveal = t()));
      })(this, function () {
        var e = (e, t) => {
          ...
          l = (e) => {
            ...
            return (
              e && e.length > 0 && t.appendChild(document.createTextNode(e)),
          ...
          d = (e, t = 0) => {
            if (e) {
              ...
              return (
                (e.style.height = `0px`),
                e.parentElement && (e.parentElement.style.height = `auto`),
                (r = t - (((n = e.parentElement) == null ? void 0 : n.offsetHeight) || 0)),
                (e.style.height = i + `px`),
                e.parentElement && e.parentElement.style.removeProperty(`height`),
                r
              );
            }
            return t;
            ...
            if (e) {
              var t = function (e) {
                ...
                p = function (e) {
                  return (
                    e.dirty !== i ||
                    (e.dirty === i && e.element.parentNode.clientWidth !== e.availableWidth)
                  );
                },
                m = function (t) {
                ...
                h = function (e) {
                  ...
                  return (
                    ...
                    e.whiteSpace !== `nowrap` && ((t = !0), (e.whiteSpace = `nowrap`)),
                ...
                S = function (e) {
                  e.observeMutations &&
                    ((e.observer = new MutationObserver(v(e, r))),
        ...
        var ee = class {
            constructor(e) {
              (S(this, `allowedToPlayAudio`, null),
                (this.Reveal = e),
            ...
            load(e, n = {}) {
              ...
              (t(e, `img[data-src], video[data-src], audio[data-src], iframe[data-src]`).forEach(
                (e) => {
                  let t = e.tagName === `IFRAME`;
                  (!t || this.shouldPreload(e)) &&
                    (e.setAttribute(`src`, e.getAttribute(`data-src`)),
                    e.setAttribute(`data-lazy-loaded`, ``),
                    e.removeAttribute(`data-src`),
                    t && e.addEventListener(`load`, this.preventIframeAutoFocus));
                },
              ),
                t(e, `video, audio`).forEach((e) => {
                  ...
                  (t(e, `source[data-src]`).forEach((e) => {
                    ...
                    g && e.tagName === `VIDEO` && e.setAttribute(`playsinline`, ``),
                    n > 0 && e.load());
                }));
              ...
              if (i) {
                  ...
                  if (a)
                    /^data:/.test(a.trim())
                      ...
                      : (t.style.backgroundImage = a
                          .split(`,`)
                          .map((e) => `url(${m(decodeURI(e.trim()))})`)
                          .join(`,`));
                  else if (o) {
                    let e = document.createElement(`video`);
                    (s && e.setAttribute(`loop`, ``),
                      (c || this.Reveal.isSpeakerNotes()) && (e.muted = !0),
                      g && e.setAttribute(`playsinline`, ``),
                      o.split(`,`).forEach((t) => {
                ...
                a &&
                  ...
                  !/autoplay=(1|true|yes)/gi.test(r) &&
                  a.getAttribute(`src`) !== r &&
              ...
              if (e) {
                ...
                (t(e, `img[src$=".gif"]`).forEach((e) => {
                  ...
                  t(e, `video, audio`).forEach((e) => {
                    ...
                    if (
                      (typeof t != `boolean` &&
                        (t = e.hasAttribute(`data-autoplay`) || !!o(e, `.slide-background`)),
                      t && typeof e.play == `function`)
                    ) {
                      if (n && !e.muted) return;
                      e.readyState > 1
                        ? this.startEmbeddedMedia({
                        ...
                        : g
                          ? (e.addEventListener(`canplay`, this.ensureMobileMediaPlaying),
                            this.playMediaElement(e))
            ...
            ensureMobileMediaPlaying(e) {
              let t = e.target;
              typeof t.getVideoPlaybackQuality == `function` &&
                setTimeout(() => {
                  let e = t.paused === !1,
            ...
            startEmbeddedMedia(e) {
              ...
              (t &&
                ...
                ((e.target.currentTime = 0), this.playMediaElement(e.target)),
                    ...
                    if (t.name === `NotAllowedError`)
                      if (((this.allowedToPlayAudio = !1), e.tagName === `VIDEO`)) {
                        ...
                        t &&
                          n &&
                          !r &&
                          (e.setAttribute(`data-muted-by-reveal`, `true`),
                          (e.muted = !0),
                          e.play().catch(() => {
            ...
            showPlayOrUnmuteButton() {
              ...
              (n > 0
                ...
                : t > 0
                  ? (r = `Unmute video`)
                  : e > 0 && (r = `Play audio`),
                (this.mediaPlayButton.textContent = r),
            ...
            resetTemporarilyMutedMedia() {
              new Set([
                ...
                e.hasAttribute(`data-muted-by-reveal`) &&
                  ((e.muted = !1), e.removeAttribute(`data-muted-by-reveal`));
              });
            }
            clearMediaPlaybackErrors() {
              (this.resetTemporarilyMutedMedia(),
                ...
                this.mediaPlayButton &&
                  this.mediaPlayButton.parentNode &&
          ...
          ne = class {
            ...
            getSlideNumber(e = this.Reveal.getCurrentSlide()) {
              ...
              if (typeof t.slideNumber == `function`) n = t.slideNumber(e);
                ...
                (typeof t.slideNumber == `string` && (r = t.slideNumber),
                  !/c/.test(r) && this.Reveal.getHorizontalSlides().length === 1 && (r = `c`));
          ...
          ie = (e) => (
            ...
            e ? (e.r * 299 + e.g * 587 + e.b * 114) / 1e3 : null
          ),
          ae = class {
            constructor(e) {
              this.Reveal = e;
            ...
            sync(e) {
              ...
              (e.classList.remove(`has-dark-background`),
                ...
                r.background &&
                  ...
                  /\.(svg|png|jpg|jpeg|gif|bmp|webp)([?#\s]|$)/gi.test(r.background)
                ...
                r.backgroundSize && t.setAttribute(`data-background-size`, r.backgroundSize),
                r.backgroundColor && (t.style.backgroundColor = r.backgroundColor),
                r.backgroundGradient && (t.style.backgroundImage = r.backgroundGradient),
                r.backgroundTransition &&
                  t.setAttribute(`data-background-transition`, r.backgroundTransition),
            ...
            getContrastClass(e) {
              ...
              if (n) {
                let e = D(n);
                if (e && e.a !== 0)
                  return ie(n) < 128 ? `has-dark-background` : `has-light-background`;
              }
              return null;
            }
            ...
            update(e = !1) {
              let n = this.Reveal.getConfig(),
                ...
                s = n.rtl ? `past` : `future`;
              if (
                (Array.from(this.element.childNodes).forEach((n, r) => {
                  (n.classList.remove(`past`, `present`, `future`),
                    r < i.h
                      ? n.classList.add(o)
                      : r > i.h
                        ? n.classList.add(s)
                        : (n.classList.add(`present`), (a = n)),
                    (e || r === i.h) &&
                      t(n, `.slide-background`).forEach((e, t) => {
                        ...
                        t < n
                          ...
                          : t > n
                            ...
                            : (e.classList.add(`present`), r === i.h && (a = e));
                      }));
                }),
              ...
              (r && this.bubbleSlideContrastClassToElement(r, this.Reveal.getRevealElement()),
                setTimeout(() => {
            ...
            updateParallax() {
              ...
              if (this.Reveal.getConfig().parallaxBackgroundImage) {
                ...
                r.length === 1
                  ? (i = a = parseInt(r[0], 10))
                  : ((i = parseInt(r[0], 10)), (a = parseInt(r[1], 10)));
                ...
                ((f =
                  typeof this.Reveal.getConfig().parallaxBackgroundVertical == `number`
                    ...
                    : (a - u) / (d - 1)),
                  (p = d > 0 ? f * e.v : 0),
                  (this.element.style.backgroundPosition = l + `px ` + -p + `px`));
              }
            }
            destroy() {
              this.element.remove();
          ...
          oe = class {
            ...
            run(e, t) {
              ...
              if (
                ...
                !(r > i ? t : e).hasAttribute(`data-auto-animate-restart`)
              ) {
                ...
                if (
                  ...
                  (this.getUnmatchedAutoAnimateElements(t).forEach((e) => {
                    ...
                    ((t.duration !== n.duration || t.delay !== n.delay) &&
                      ((r = `unmatched-` + O++),
                      o.push(
                        `[data-auto-animate="running"] [data-auto-animate-target="${r}"] { transition: opacity ${t.duration}s ease ${t.delay}s; }`,
                      )),
                      (e.dataset.autoAnimateTarget = r));
                  }, this),
                    o.push(
                      `[data-auto-animate="running"] [data-auto-animate-target="unmatched"] { transition: opacity ${e}s ease ${r}s; }`,
                    ));
                }
            ...
            autoAnimateElements(e, t, n, r, i) {
              ...
              (n.delay !== void 0 && (a.delay = n.delay),
                n.duration !== void 0 && (a.duration = n.duration),
                n.easing !== void 0 && (a.easing = n.easing));
              ...
              if (
                ...
                ((t.x = Math.round(t.x * 1e3) / 1e3),
                  (t.y = Math.round(t.y * 1e3) / 1e3),
                  (t.scaleX = Math.round(t.scaleX * 1e3) / 1e3),
                  (t.scaleX = Math.round(t.scaleX * 1e3) / 1e3));
                let r = n.translate !== !1 && (t.x !== 0 || t.y !== 0),
                  i = n.scale !== !1 && (t.scaleX !== 0 || t.scaleY !== 0);
                if (r || i) {
                  let e = [];
                  (r && e.push(`translate(${t.x}px, ${t.y}px)`),
                    i && e.push(`scale(${t.scaleX}, ${t.scaleY})`),
              ...
              for (let e in s.styles) {
                ...
                t === n
                  ? delete s.styles[e]
                  : (t.explicitValue === !0 && (s.styles[e] = t.value),
                    n.explicitValue === !0 && (o.styles[e] = n.value));
              }
              let c = ``,
                l = Object.keys(s.styles);
              if (l.length > 0) {
                ((o.styles.transition = `none`),
                  (s.styles.transition = `all ${a.duration}s ${a.easing} ${a.delay}s`),
                  (s.styles[`transition-property`] = l.join(`, `)),
                  (s.styles[`will-change`] = l.join(`, `)));
                let e = Object.keys(o.styles)
                    .map((e) => e + `: ` + o.styles[e] + ` !important;`)
                    .join(``),
                  t = Object.keys(s.styles)
                    .map((e) => e + `: ` + s.styles[e] + ` !important;`)
                    .join(``);
                c =
            ...
            getAutoAnimateOptions(t, n) {
              ...
              return (
                t.dataset.autoAnimateEasing && (r.easing = t.dataset.autoAnimateEasing),
                t.dataset.autoAnimateDuration &&
                  (r.duration = parseFloat(t.dataset.autoAnimateDuration)),
                t.dataset.autoAnimateDelay && (r.delay = parseFloat(t.dataset.autoAnimateDelay)),
                r
              );
            }
            getAutoAnimatableProperties(e, t, n) {
              ...
              return (
                (n.styles || r.autoAnimateStyles).forEach((t) => {
                  let n;
                  (typeof t == `string` &&
                    (t = {
                      property: t,
                    }),
                    t.from !== void 0 && e === `from`
                      ? (n = {
                          value: t.from,
                          explicitValue: !0,
                        })
                      : t.to !== void 0 && e === `to`
                        ...
                        : (t.property === `line-height` &&
                            (n = parseFloat(a[`line-height`]) / parseFloat(a[`font-size`])),
                          isNaN(n) && (n = a[t.property])),
            ...
            getUnmatchedAutoAnimateElements(e) {
              return [].slice.call(e.children).reduce((e, t) => {
                ...
                return (
                  !t.hasAttribute(`data-auto-animate-target`) && !n && e.push(t),
          ...
          ce = class {
            ...
            activate() {
              ...
              let o = [],
                ...
                l = (e, t, n, a) => {
                  let s;
                  if (c && this.Reveal.shouldAutoAnimateBetween(c, e))
                    ((s = document.createElement(`div`)),
                      (s.className = `scroll-page-content scroll-auto-animate-page`),
                      (s.style.display = `none`),
                      c.closest(`.scroll-page-content`).parentNode.appendChild(s));
                  else {
                    ...
                    if (((e.className = `scroll-page`), o.push(e), a && r.length > t)) {
                      ...
                      a && a.background
                        ? (e.style.background = a.background)
                        : i && (e.style.background = i);
                    } else i && (e.style.background = i);
                    let n = document.createElement(`div`);
                    ((n.className = `scroll-page-sticky`),
                      e.appendChild(n),
                      (s = document.createElement(`div`)),
                      (s.className = `scroll-page-content`),
                      n.appendChild(s));
                  }
                  (s.appendChild(e),
                    ...
                    e.slideBackgroundElement &&
                      ...
                      s.insertBefore(e.slideBackgroundElement, e)),
                    (c = e));
                };
              (n.forEach((e, t) => {
                this.Reveal.isVerticalStack(e)
                  ? e.querySelectorAll(`section`).forEach((e, n) => {
                      l(e, t, n, !0);
                    })
                  : l(e, t, 0);
              }, this),
            ...
            deactivate() {
              ...
              ((this.active = !1),
                ...
                this.pendingScrollRaf &&
                  (cancelAnimationFrame(this.pendingScrollRaf), (this.pendingScrollRaf = 0)),
            ...
            syncPages() {
              let e = this.Reveal.getConfig(),
                ...
                a = t.height * n,
                o = r ? a : i;
              ((this.scrollTriggerHeight = r ? a : i),
                this.viewportElement.style.setProperty(`--page-height`, o + `px`),
                ...
                (this.pages = Array.from(
                  ...
                  (a.pageElement.style.setProperty(
                    `--slide-height`,
                    ...
                    this.createFragmentTriggersForPage(a),
                    a.autoAnimateElements.length > 0 && this.createAutoAnimateTriggersForPage(a));
                  let s = Math.max(a.scrollTriggers.length - 1, 0);
                  ((s += a.autoAnimatePages.reduce(
                    (e, t) => e + Math.max(t.scrollTriggers.length - 1, 0),
                    a.autoAnimatePages.length,
                  )),
                    a.pageElement
                  ...
                  for (let e = 0; e < s + 1; e++) {
                    ...
                    ((t.className = `scroll-snap-point`),
                      ...
                      (t.style.scrollSnapAlign = r ? `center` : `start`),
                      a.pageElement.appendChild(t),
                      e === 0 && (t.style.marginTop = -this.scrollTriggerHeight + `px`));
                  }
                  return (
                    r && a.scrollTriggers.length > 0
                      ? ((a.pageHeight = i),
                        a.pageElement.style.setProperty(`--page-height`, i + `px`))
                      : ((a.pageHeight = o), a.pageElement.style.removeProperty(`--page-height`)),
                    (a.scrollPadding = this.scrollTriggerHeight * s),
                    (a.totalHeight = a.pageHeight + a.scrollPadding),
                    a.pageElement.style.setProperty(
                      `--page-scroll-padding`,
                      a.scrollPadding + `px`,
                    ),
                    s > 0
                      ? ((a.stickyElement.style.position = `sticky`),
                        (a.stickyElement.style.top = Math.max((i - a.pageHeight) / 2, 0) + `px`))
                      : ((a.stickyElement.style.position = `relative`),
                        (a.pageElement.style.scrollSnapAlign =
                          a.pageHeight < i ? `center` : `start`)),
                    a
                  );
                })),
            ...
            createAutoAnimateTriggersForPage(e) {
              e.autoAnimateElements.length > 0 &&
                this.slideTriggers.push(
                  ...Array.from(e.autoAnimateElements).map((t, n) => {
                    ...
                    return (
                      this.createFragmentTriggersForPage(r, r.slideElement),
            ...
            syncProgressBar() {
              (this.progressBarInner
                ...
                (this.activeProgressBarPage = null),
                (this.activeProgressBarTrigger = null),
                this.getAllPages().forEach((e) => {
                  ((e.progressBarSlide = null),
                    e.scrollTriggers.forEach((e) => (e.progressBarElement = null)));
                }));
              let e = this.viewportElement.scrollHeight,
                t = this.viewportElement.offsetHeight,
                n = t / e;
              ((this.progressBarHeight = this.progressBarInner.offsetHeight),
                (this.playheadHeight = Math.max(n * this.progressBarHeight, j)),
                (this.progressBarScrollableHeight = this.progressBarHeight - this.playheadHeight));
              let r = (t / e) * this.progressBarHeight,
                i = Math.min(r / 8, A);
              ((this.progressBarPlayhead.style.height = this.playheadHeight - i + `px`),
                r > se &&
                  this.slideTriggers.forEach((e) => {
                    ...
                    ((t.progressBarSlide = document.createElement(`div`)),
                      ...
                      (t.progressBarSlide.style.height =
                        (e.range[1] - e.range[0]) * this.progressBarHeight - i + `px`),
                      t.progressBarSlide.classList.toggle(
                        `has-triggers`,
                        t.scrollTriggers.length > 0,
                      ),
                      this.progressBarInner.appendChild(t.progressBarSlide),
                      t.scrollTriggers.forEach((n, r) => {
                        let a = document.createElement(`div`);
                        ((a.className = `scrollbar-trigger`),
                          (a.style.top = (n.range[0] - e.range[0]) * this.progressBarHeight + `px`),
                          (a.style.height =
                            (n.range[1] - n.range[0]) * this.progressBarHeight - i + `px`),
                          t.progressBarSlide.appendChild(a),
                          r === 0 && (a.style.display = `none`),
                          (n.progressBarElement = a));
                      }));
                  }));
            }
            syncScrollPosition() {
              ...
              (this.slideTriggers.forEach((e) => {
                let { page: n } = e;
                (i >= e.range[0] - t * 2 && i <= e.range[1] + t * 2 && !n.loaded
                  ? ((n.loaded = !0), this.Reveal.slideContent.load(n.slideElement))
                  : n.loaded && ((n.loaded = !1), this.Reveal.slideContent.unload(n.slideElement)),
                  i >= e.range[0] && i <= e.range[1]
                    ? (this.activateTrigger(e), (o = e.page))
                    : e.active && this.deactivateTrigger(e));
              }),
                o &&
                  o.scrollTriggers.forEach((e) => {
                    a >= e.range[0] && a <= e.range[1]
                      ? (this.activateTrigger(e), (s = e))
                      : e.active && this.deactivateTrigger(e);
                  }),
            ...
            setProgressBarValue(e, t = null, n = null) {
              if (this.progressBar) {
                if (
                  ...
                  this.activeProgressBarPage !== t)
                ) {
                  var r, i;
                  ((r = this.activeProgressBarPage) == null ||
                    (r = r.progressBarSlide) == null ||
                    r.classList.remove(`active`),
                    t == null || (i = t.progressBarSlide) == null || i.classList.add(`active`),
                    (this.activeProgressBarPage = t));
                }
                if (this.activeProgressBarTrigger !== n) {
                  var a, o;
                  ((a = this.activeProgressBarTrigger) == null ||
                    (a = a.progressBarElement) == null ||
                    a.classList.remove(`active`),
                    n == null || (o = n.progressBarElement) == null || o.classList.add(`active`),
                    (this.activeProgressBarTrigger = n));
                }
                this.showProgressBar();
              }
            }
            ...
            activatePage(e) {
              if (!e.active) {
                ...
                ((r.style.display = `block`),
                  ...
                  Array.from(r.parentNode.querySelectorAll(`.scroll-page-content`)).forEach((e) => {
        ...
        var le = class {
            ...
            activate() {
              ...
              return N(function* () {
                ...
                (yield new Promise(requestAnimationFrame),
                  l(`@page{size:` + o + `px ` + s + `px; margin: 0px;}`),
                  l(
                  ...
                  (document.body.style.width = o + `px`),
                ...
                (yield new Promise(requestAnimationFrame),
                  e.Reveal.layoutSlideContents(c, u),
                  yield new Promise(requestAnimationFrame));
                ...
                (r.forEach(function (e, r) {
                  if (e.classList.contains(`stack`) === !1) {
                    ...
                    ((h = Math.min(h, n.pdfMaxPagesPerSlide)),
                      ((h === 1 && n.center) || e.classList.contains(`center`)) &&
                        (l = Math.max((s - d) / 2, 0)));
                    let _ = document.createElement(`div`);
                    if (
                      (m.push(_),
                      (_.className = `pdf-page`),
                      (_.style.height = (s + n.pdfPageHeightOffset) * h + `px`),
                      f && (_.style.background = f),
                      _.appendChild(e),
                      (e.style.left = a + `px`),
                      (e.style.top = l + `px`),
                      (e.style.width = c + `px`),
                      this.Reveal.slideContent.layout(e),
                      e.slideBackgroundElement && _.insertBefore(e.slideBackgroundElement, e),
                      n.showNotes)
                    ) {
                      ...
                      if (t) {
                        ...
                        (r.classList.add(`speaker-notes`),
                          r.classList.add(`speaker-notes-pdf`),
                          r.setAttribute(`data-layout`, e),
                          (r.innerHTML = t),
                          e === `separate-page`
                            ? m.push(r)
                            : ((r.style.left = `8px`),
                              (r.style.bottom = `8px`),
                              (r.style.width = o - 16 + `px`),
                              _.appendChild(r)));
                      }
                    }
                    if (i) {
                    ...
                    if (n.pdfSeparateFragments) {
                      ...
                      t(_, `.fragment:not(.fade-out)`).forEach(function (e) {
                        e.classList.add(`visible`);
                      });
                  }
                }, e),
                  yield new Promise(requestAnimationFrame),
                  m.forEach((e) => h.appendChild(e)),
                  e.Reveal.slideContent.layout(e.Reveal.getSlidesElement()),
                  e.Reveal.dispatchEvent({
                    type: `pdf-ready`,
                  }),
          ...
          ue = class {
            ...
            update(e, t, n = this.Reveal.getCurrentSlide()) {
              ...
              if (
                ...
                ((t = t || this.sort(n.querySelectorAll(`.fragment`))), t.length)
              ) {
                let i = 0;
                if (typeof e != `number`) {
            ...
            activate() {
              if (
                ...
                ((this.active = !0),
                  ...
                  t(this.Reveal.getRevealElement(), C).forEach((e) => {
                    e.classList.contains(`stack`) ||
                      e.addEventListener(`click`, this.onSlideClicked, !0);
                  }));
                let e = this.Reveal.getComputedSlideSize();
                ((this.overviewSlideWidth = e.width + 70),
                  (this.overviewSlideHeight = e.height + 70),
            ...
            layout() {
              (this.Reveal.getHorizontalSlides().forEach((e, n) => {
                (e.setAttribute(`data-index-h`, n),
                  i(e, `translate3d(` + n * this.overviewSlideWidth + `px, 0, 0)`),
                  e.classList.contains(`stack`) &&
          ...
          fe = class {
            ...
            onDocumentKeyDown(e) {
              ...
              if (
                (this.Reveal.isOverlayOpen() && ![`Escape`, `f`, `c`, `b`, `.`].includes(e.key)) ||
                (this.Reveal.isPaused() && l.indexOf(n) === -1)
              )
                return !1;
              let d =
                ...
                n === 80 || n === 33
                  ...
                  : n === 78 || n === 34
                    ...
                    : n === 72 || n === 37
                      ? e.shiftKey
                        ? this.Reveal.slide(0)
                        : !this.Reveal.overview.isActive() && d
                          ? t.rtl
                            ? this.Reveal.next({
                                skipFragments: e.altKey,
                              })
                            ...
                            : n === 36
                              ...
                              : n === 35
                                ...
                                : n === 32
                                  ...
                                  : [58, 59, 66, 86, 190].includes(n) || (n === 191 && !e.shiftKey)
                                    ...
                                    : n === 70
                                      ...
                                      : n === 65
                                        ? t.autoSlideStoppable && this.Reveal.toggleAutoSlide(r)
                                        : n === 71
                                          ? t.jumpToSlide && this.Reveal.toggleJumpToSlide()
                                          : n === 67 && this.Reveal.isOverlayOpen()
                                            ? this.Reveal.closeOverlay()
                                            : ((n === 63 || n === 191) && e.shiftKey) || n === 112
        ...
        var pe = class {
            constructor(e) {
              (S(this, `MAX_REPLACE_STATE_FREQUENCY`, 1e3),
                (this.Reveal = e),
            ...
            getIndicesFromHash(e = window.location.hash, t = {}) {
              ...
              if (!/^[0-9]*$/.test(r[0]) && n.length) {
                let e, t;
                /\/[-\d]+$/g.test(n) &&
                  ((t = parseInt(n.split(`/`).pop(), 10)),
                  (t = isNaN(t) ? void 0 : t),
                  (n = n.split(`/`).shift()));
                try {
                  let t = decodeURIComponent(n);
                  e = (
                    document.getElementById(t) || document.querySelector(`[data-id="${t}"]`)
                  ).closest(`.slides section`);
                } catch (e) {}
                if (e)
                  return F(
                    F({}, this.Reveal.getIndices(e)),
                    {},
                    {
                      f: t,
                    },
                ...
                let e = this.Reveal.getConfig(),
                  ...
                  o;
                return (
                  e.fragmentInURL && ((o = parseInt(r[2], 10)), isNaN(o) && (o = void 0)),
                  {
                    h: i,
                    v: a,
                    f: o,
          ...
          me = class {
			...
			<button class="navigate-down" aria-label="below slide"><div class="controls-arrow"></div></button>`),
                this.Reveal.getRevealElement().appendChild(this.element),
                (this.controlsLeft = t(n, `.navigate-left`)),
                (this.controlsRight = t(n, `.navigate-right`)),
                (this.controlsUp = t(n, `.navigate-up`)),
                (this.controlsDown = t(n, `.navigate-down`)),
                (this.controlsPrev = t(n, `.navigate-prev`)),
                (this.controlsNext = t(n, `.navigate-next`)),
                (this.controlsFullscreen = t(n, `.enter-fullscreen`)),
            ...
            configure(e, t) {
              ...
              ((this.element.style.display =
                e.controls && (!n || this.Reveal.isSpeakerNotes()) ? `block` : `none`),
              ...
              if (this.Reveal.getConfig().controlsTutorial) {
                ...
                !this.Reveal.hasNavigatedVertically() && e.down
                  ...
                  : (this.controlsDownArrow.classList.remove(`highlight`),
                    this.Reveal.getConfig().rtl
                      ? !this.Reveal.hasNavigatedHorizontally() && e.left && t.v === 0
                        ? this.controlsLeftArrow.classList.add(`highlight`)
                        : this.controlsLeftArrow.classList.remove(`highlight`)
                      : !this.Reveal.hasNavigatedHorizontally() && e.right && t.v === 0
...
` +
          ...
          ve = class {
                  ...
                  if (
                    (t.forEach((e) => {
                      (!e.condition || e.condition()) &&
                        (e.async ? this.asyncDependencies.push(e) : n.push(e));
                    }),
                    n.length)
                  ) {
                    r = n.length;
                    let t = (t) => {
                      (t && typeof t.callback == `function` && t.callback(),
                        --r === 0 && this.initPlugins().then(e));
                    };
                    n.forEach((e) => {
                      typeof e.id == `string`
            ...
            registerPlugin(e) {
              arguments.length === 2 && typeof arguments[0] == `string`
                ? ((e = arguments[1]), (e.id = arguments[0]))
          ...
          ye = class {
            ...
            update() {
              ...
              let e =
                  this.Reveal.getSlidesElement().querySelectorAll(this.iframeTriggerSelector)
                    .length > 0,
                t =
                  this.Reveal.getSlidesElement().querySelectorAll(this.mediaTriggerSelector)
                    .length > 0;
              e || t
			...
			<div class="r-overlay-content"></div>`));
              ...
              if (t === `image`) {
                  ...
                  t.addEventListener(
                    ...
                    () => {
                      ((this.dom.dataset.state = `error`),
                        (r.innerHTML = `<span class="r-overlay-error">Unable to load image.</span>`));
                    },
                    !1,
                  ),
                ...
                ((t.autoplay = this.dom.dataset.previewAutoplay !== `false`),
                  (t.controls = this.dom.dataset.previewControls !== `false`),
                  (t.loop = this.dom.dataset.previewLoop === `true`),
                  (t.muted = this.dom.dataset.previewMuted === `true`),
                  (t.playsInline = !0),
                  (t.src = e),
                  r.appendChild(t),
                  t.addEventListener(
                  ...
                  t.addEventListener(
                    ...
                    () => {
                      ((this.dom.dataset.state = `error`),
                        (r.innerHTML = `<span class="r-overlay-error">Unable to load video.</span>`));
                    },
                    !1,
                  ),
                  this.Reveal.dispatchEvent({
            ...
            showHelp() {
              if (this.Reveal.getConfig().help) {
                ...
                for (let t in n)
                  n[t].key &&
                    n[t].description &&
                    (e += `<tr><td>${n[t].key}</td><td>${n[t].description}</td></tr>`);
                ((e += `</table>`),
          ...
          be = class {
            ...
            bind() {
              ...
              `onpointerdown` in window
                ? (e.addEventListener(`pointerdown`, this.onPointerDown, !1),
                  ...
                  e.addEventListener(`pointercancel`, this.onPointerCancel, !1))
            ...
            unbind() {
              ...
              (e.removeEventListener(`pointerdown`, this.onPointerDown, !1),
                ...
                e.removeEventListener(`pointercancel`, this.onPointerCancel, !1),
                ...
                if (e.touches.length === 1 && this.touchStartCount !== 2) {
                  ...
                  (a > I && Math.abs(a) > Math.abs(o)
                    ...
                    : a < -I && Math.abs(a) > Math.abs(o)
                      ...
                      : o > I && i.up
                        ? ((this.touchCaptured = !0),
                          t.navigationMode === `linear` ? this.Reveal.prev() : this.Reveal.up())
                        : o < -I &&
                          i.down &&
                          ((this.touchCaptured = !0),
                          t.navigationMode === `linear` ? this.Reveal.next() : this.Reveal.down()),
                    t.embedded
            ...
            onTouchEnd(e) {
              (this.touchCaptured &&
                !this.Reveal.slideContent.isAllowedToPlayAudio() &&
            ...
            onPointerDown(e) {
              e.pointerType === `touch` &&
                ...
                (e.touches = this.getActiveTouches()),
                this.onTouchStart(e));
            }
            onPointerMove(e) {
              e.pointerType === `touch` &&
          ...
          Se = class {
            ...
            getSlideNotes(e = this.Reveal.getCurrentSlide()) {
              ...
              return t
                ? Array.from(t).map((e) => e.innerHTML).join(`
`)
                : null;
            }
            destroy() {
          ...
          Ce = class {
            ...
            render() {
              ...
              (this.context.save(),
                ...
                this.context.arc(n, r, t + 4, 0, Math.PI * 2, !1),
                (this.context.fillStyle = `rgba( 0, 0, 0, 0.4 )`),
                this.context.fill(),
                this.context.beginPath(),
                this.context.arc(n, r, t, 0, Math.PI * 2, !1),
                (this.context.lineWidth = this.thickness),
                (this.context.strokeStyle = `rgba( 255, 255, 255, 0.2 )`),
                this.context.stroke(),
                this.playing &&
                  (this.context.beginPath(),
                  this.context.arc(n, r, t, a, i, !1),
                  (this.context.lineWidth = this.thickness),
                  (this.context.strokeStyle = `#fff`),
                  this.context.stroke()),
                this.context.translate(n - 28 / 2, r - 28 / 2),
                this.playing
                  ? ((this.context.fillStyle = `#fff`),
                    this.context.fillRect(0, 0, 28 / 2 - 4, 28),
                    this.context.fillRect(18, 0, 28 / 2 - 4, 28))
                  : (this.context.beginPath(),
                    this.context.translate(4, 0),
                    this.context.moveTo(0, 0),
                    this.context.lineTo(24, 28 / 2),
        ...
        function z(a, s) {
          ...
          function Oe(e) {
            ...
            if (((p = !0), (D.wrapper = a), (D.slides = a.querySelector(`.slides`)), !D.slides))
              throw `Unable to find slides container (<div class="slides">).`;
            return (
              (f = F(F(F(F(F({}, we), f), s), e), u())),
              /print-pdf/gi.test(window.location.search) && (f.view = `print`),
              ke(),
              window.addEventListener(`load`, X, !1),
              G.load(f.plugins, f.dependencies).then(Ae),
              new Promise((e) => l.on(`ready`, e))
            );
          }
          function ke() {
            (f.embedded === !0
              ? (D.viewport = o(a, `.reveal-viewport`) || a)
              : ((D.viewport = document.body),
                document.documentElement.classList.add(`reveal-full-page`)),
              D.viewport.classList.add(`reveal-viewport`));
          }
          function Ae() {
            p !== !1 &&
              ((m = !0),
              ...
              H.readURL(),
              setTimeout(() => {
                (D.slides.classList.remove(`no-transition`),
                  D.wrapper.classList.add(`ready`),
                  Y({
                    type: `ready`,
                    data: {
                      indexh: h,
          ...
          function je() {
            ...
            (e || t) &&
              (e ? Ue() : De.unbind(),
              D.viewport.classList.add(`loading-scroll-mode`),
              e
                ? document.readyState === `complete`
                  ? R.activate()
                  : window.addEventListener(`load`, () => R.activate())
                : L.activate());
          }
          function Me() {
            f.showHiddenSlides ||
              t(D.wrapper, `section[data-visibility="hidden"]`).forEach((e) => {
                let t = e.parentNode;
                t.childElementCount === 1 && /section/i.test(t.nodeName) ? t.remove() : e.remove();
              });
          }
          function Ne() {
            (D.slides.classList.add(`no-transition`),
              g ? D.wrapper.classList.add(`no-hover`) : D.wrapper.classList.remove(`no-hover`),
              I.render(),
              N.render(),
              P.render(),
              U.render(),
              ...
              (D.pauseOverlay = c(
                ...
                `div`,
                `pause-overlay`,
                f.controls ? `<button class="resume-button">Resume presentation</button>` : null,
              )),
              (D.statusElement = Pe()),
              D.wrapper.setAttribute(`role`, `application`));
          }
          function Pe() {
          ...
          function Re() {
            setInterval(() => {
              ((!L.isActive() && D.wrapper.scrollTop !== 0) || D.wrapper.scrollLeft !== 0) &&
                ((D.wrapper.scrollTop = 0), (D.wrapper.scrollLeft = 0));
            }, 1e3);
          }
          function ze() {
          ...
          function Ve(t) {
            ...
            (D.wrapper.classList.remove(r.transition),
              D.wrapper.classList.add(f.transition),
              D.wrapper.setAttribute(`data-transition-speed`, f.transitionSpeed),
              D.wrapper.setAttribute(`data-background-transition`, f.backgroundTransition),
              D.viewport.style.setProperty(
                `--slide-width`,
                typeof f.width == `string` ? f.width : f.width + `px`,
              ),
              D.viewport.style.setProperty(
                `--slide-height`,
                typeof f.height == `string` ? f.height : f.height + `px`,
              ),
              f.shuffle && vt(),
              n(D.wrapper, `embedded`, f.embedded),
              n(D.wrapper, `rtl`, f.rtl),
              n(D.wrapper, `center`, f.center),
              f.pause === !1 && st(),
              _e.reset(),
              k && (k.destroy(), (k = null)),
              i > 1 &&
                f.autoSlide &&
                f.autoSlideStoppable &&
                ((k = new Ce(D.wrapper, () => Math.min(Math.max((Date.now() - se) / O, 0), 1))),
                k.on(`click`, en),
                (j = !1)),
              f.navigationMode === `default`
                ? D.wrapper.removeAttribute(`data-navigation-mode`)
                : D.wrapper.setAttribute(`data-navigation-mode`, f.navigationMode),
              J.configure(f, r),
              q.configure(f, r),
              Ee.configure(f, r),
              U.configure(f, r),
          ...
          function He() {
            (window.addEventListener(`resize`, Zt, !1),
              ...
              f.keyboard && V.bind(),
              f.progress && W.bind(),
              f.respondToHashChanges && H.bind(),
              U.bind(),
              q.bind(),
              D.slides.addEventListener(`click`, Xt, !1),
              D.slides.addEventListener(`transitionend`, Yt, !1),
              D.pauseOverlay.addEventListener(`click`, st, !1),
              f.focusBodyOnPageVisibilityChange &&
          ...
          function Ue() {
            (De.unbind(),
              ...
              D.slides.removeEventListener(`click`, Xt, !1),
              D.slides.removeEventListener(`transitionend`, Yt, !1),
              D.pauseOverlay.removeEventListener(`click`, st, !1));
          }
          function We() {
            ((p = !1),
              m !== !1 &&
                ...
                D.pauseOverlay && D.pauseOverlay.remove(),
                D.statusElement && D.statusElement.remove(),
                ...
                D.wrapper.removeAttribute(`data-transition-speed`),
                D.wrapper.removeAttribute(`data-background-transition`),
                D.viewport.classList.remove(`reveal-viewport`),
                D.viewport.style.removeProperty(`--slide-width`),
                D.viewport.style.removeProperty(`--slide-height`),
                D.slides.style.removeProperty(`width`),
                D.slides.style.removeProperty(`height`),
                D.slides.style.removeProperty(`zoom`),
                D.slides.style.removeProperty(`left`),
                D.slides.style.removeProperty(`top`),
                D.slides.style.removeProperty(`bottom`),
                D.slides.style.removeProperty(`right`),
                D.slides.style.removeProperty(`transform`),
                Array.from(D.wrapper.querySelectorAll(C)).forEach((e) => {
          ...
          function qe(e) {
            (typeof e.layout == `string` && (T.layout = e.layout),
              typeof e.overview == `string` && (T.overview = e.overview),
              T.layout ? i(D.slides, T.layout + ` ` + T.overview) : i(D.slides, T.overview));
          }
            ...
            if (D.wrapper && !R.isActive()) {
              ...
              if (!f.disableLayout) {
                ...
                let n = L.isActive() ? Qe(e, t) : Qe(),
                  r = S;
                (Xe(f.width, f.height),
                  (D.slides.style.width = n.width + `px`),
                  (D.slides.style.height = n.height + `px`),
                  (S = Math.min(n.presentationWidth / n.width, n.presentationHeight / n.height)),
                  (S = Math.max(S, f.minScale)),
                  (S = Math.min(S, f.maxScale)),
                  S === 1 || L.isActive()
                    ? ((D.slides.style.zoom = ``),
                      (D.slides.style.left = ``),
                      (D.slides.style.top = ``),
                      (D.slides.style.bottom = ``),
                      (D.slides.style.right = ``),
                      qe({
                        layout: ``,
                      }))
                    : ((D.slides.style.zoom = ``),
                      (D.slides.style.left = `50%`),
                      (D.slides.style.top = `50%`),
                      (D.slides.style.bottom = `auto`),
                      (D.slides.style.right = `auto`),
                      qe({
                        layout: `translate(-50%, -50%) scale(` + S + `)`,
                      })));
                let i = Array.from(D.wrapper.querySelectorAll(C)).filter(
                    (e) => e.style.display !== `none`,
                  ),
                  a = Array(i.length);
                for (let e = 0, t = i.length; e < t; e++) {
                  let t = i[e];
                  f.center || t.classList.contains(`center`)
                    ? t.classList.contains(`stack`)
                      ? (a[e] = 0)
                      : (a[e] = Math.max((n.height - t.scrollHeight) / 2, 0) + `px`)
                    : (a[e] = ``);
                }
              ...
              (Ze(),
                D.viewport.style.setProperty(`--slide-scale`, S),
                D.viewport.style.setProperty(`--viewport-width`, e + `px`),
                D.viewport.style.setProperty(`--viewport-height`, t + `px`),
                L.layout(),
                W.update(),
                I.updateParallax(),
                B.isActive() && B.update());
          ...
          function Ze() {
            if (
              ...
              !f.disableLayout &&
              !R.isActive() &&
              typeof f.scrollActivationWidth == `number` &&
              f.view !== `scroll`
            ) {
              let e = Qe();
              e.presentationWidth > 0 && e.presentationWidth <= f.scrollActivationWidth
                ? L.isActive() || (I.create(), L.activate())
                : L.isActive() && L.deactivate();
            }
          }
          function Qe(e, t) {
            let n = f.width,
            ...
            return (
              (i.presentationWidth -= i.presentationWidth * f.margin),
              (i.presentationHeight -= i.presentationHeight * f.margin),
          ...
          function et(e) {
            if (
              ...
              let t = e.hasAttribute(`data-start-indexv`)
                ? `data-start-indexv`
          ...
          function ot() {
            if (f.pause) {
              ...
              (Rt(),
                D.wrapper.classList.add(`paused`),
                e === !1 &&
                  Y({
                    type: `paused`,
                  }));
          ...
          function st() {
            let e = D.wrapper.classList.contains(`paused`);
            (D.wrapper.classList.remove(`paused`),
              Lt(),
              e &&
                Y({
                  type: `resumed`,
          ...
          function Z(e, t, n, r) {
            ...
            (t === void 0 && !B.isActive() && (t = et(i[e])),
              v && v.parentNode && v.parentNode.classList.contains(`stack`) && $e(v.parentNode, _));
            let o = x.concat();
            x.length = 0;
            let s = h || 0,
              c = _ || 0;
            ...
            (l &&
              ...
              ((ie = `running`),
              (p = pt(v, y, s, c)),
              p && D.slides.classList.add(`disable-slide-transitions`)),
              St(),
              X(),
              B.isActive() && B.update(),
              n !== void 0 && z.goto(n),
            ...
            stateLoop: for (let e = 0, t = x.length; e < t; e++) {
              ...
              (D.viewport.classList.add(x[e]),
                Y({
                  type: x[e],
                }));
            }
            for (; o.length; ) D.viewport.classList.remove(o.pop());
            (l && (M.afterSlideChanged(), Je(r)),
              (l || !v) && (M.stopEmbeddedContent(v), M.startEmbeddedContent(y)),
              requestAnimationFrame(() => {
                Fe(Ie(y));
              }),
              W.update(),
          ...
          function pt(e, t, n, r) {
            return (
              ...
              t.hasAttribute(`data-auto-animate`) &&
              e.getAttribute(`data-auto-animate-id`) === t.getAttribute(`data-auto-animate-id`) &&
              !(h > n || _ > r ? t : e).hasAttribute(`data-auto-animate-restart`)
            );
          }
          function mt(e, t, n) {
            let r = h || 0;
            ...
            ((v = y),
              (y = e),
              y && v && f.autoAnimate && pt(v, y, r, _) && _e.run(v, y),
              i &&
                (M.afterSlideChanged(),
                v && (M.stopEmbeddedContent(v), M.stopEmbeddedContent(v.slideBackgroundElement)),
                M.startEmbeddedContent(y),
                M.startEmbeddedContent(y.slideBackgroundElement)),
              requestAnimationFrame(() => {
                Fe(Ie(y));
              }),
              Je());
          ...
          function ht() {
            (Ue(),
              ...
              I.create(),
              H.writeURL(),
              f.sortFragmentsOnSync === !0 && z.sortAll(),
              h !== void 0 && ((h = yt(w, h)), (_ = yt(te, _))),
              U.update(),
              W.update(),
              St(),
              J.update(),
              ...
              I.update(!0),
              N.update(),
              M.formatEmbeddedContent(),
              f.autoPlayMedia === !1
                ? M.stopEmbeddedContent(y, {
                    unloadIframes: !1,
                  })
                : M.startEmbeddedContent(y),
              B.isActive() && B.layout(),
          ...
          function yt(e, n) {
            let r = t(D.wrapper, e),
              ...
              s = !1;
            if (i) {
              (f.loop && (n >= i && (o = !0), (n %= i), n < 0 && ((n = i + n), (s = !0))),
                (n = Math.max(Math.min(n, i - 1), 0)));
              for (let e = 0; e < i; e++) {
                let t = r[e],
                  i = f.rtl && !tt(t);
                if (
                ...
                e < n
                  ? (t.classList.add(i ? `future` : `past`), f.fragments && bt(t))
                  : e > n
                    ? (t.classList.add(i ? `past` : `future`), f.fragments && xt(t))
                    : e === n && f.fragments && (o ? xt(t) : s && bt(t));
              }
              let e = r[n],
          ...
          function St() {
            ...
            if (n && h !== void 0) {
              ...
              for (let s = 0; s < n; s++) {
                ...
                if (
                  ((r = Math.abs((h || 0) - s) || 0),
                  f.loop && (r = Math.abs(((h || 0) - s) % (n - o)) || 0),
                  r < o ? M.load(c) : M.unload(c),
                  u)
                ) {
                  let e = a ? 0 : et(c);
                  for (let t = 0; t < u; t++) {
                    let n = l[t];
                    ((i = Math.abs(s === (h || 0) ? (_ || 0) - t : t - e)),
                      r + i < o ? M.load(n) : M.unload(n));
                  }
                }
              }
              (At()
                ? D.wrapper.classList.add(`has-vertical-slides`)
                : D.wrapper.classList.remove(`has-vertical-slides`),
                kt()
                  ? D.wrapper.classList.add(`has-horizontal-slides`)
                  : D.wrapper.classList.remove(`has-horizontal-slides`));
            }
          }
          function Q({ includeFragments: e = !1 } = {}) {
            ...
            if (
              (f.loop &&
                (t.length > 1 && ((r.left = !0), (r.right = !0)),
                n.length > 1 && ((r.up = !0), (r.down = !0))),
              t.length > 1 &&
                f.navigationMode === `linear` &&
                ((r.right = r.right || r.down), (r.left = r.left || r.up)),
              e === !0)
            ) {
              let e = z.availableRoutes();
              ((r.left = r.left || e.prev),
                (r.up = r.up || e.prev),
                (r.down = r.down || e.next),
                (r.right = r.right || e.next));
            }
            if (f.rtl) {
              let e = r.left;
          ...
          function Tt(e) {
            ...
            if (e)
              if (L.isActive())
                ((n = parseInt(e.getAttribute(`data-index-h`), 10)),
                  e.getAttribute(`data-index-v`) &&
                    (r = parseInt(e.getAttribute(`data-index-v`), 10)));
              else {
                let i = tt(e),
                  a = i ? e.parentNode : e,
                  o = $();
                ((n = Math.max(o.indexOf(a), 0)),
                  (r = void 0),
                  i && (r = Math.max(t(e.parentNode, `section`).indexOf(e), 0)));
              }
            if (!e && y && y.querySelectorAll(`.fragment`).length > 0) {
              ...
              i =
                e && e.hasAttribute(`data-fragment-index`)
                  ...
                  : y.querySelectorAll(`.fragment.visible`).length - 1;
            }
            return {
              h: n,
              v: r,
          ...
          function It(e) {
            if (typeof e == `object`) {
              ...
              let t = r(e.paused),
                n = r(e.overview);
              (typeof t == `boolean` && t !== lt() && ct(t),
                typeof n == `boolean` && n !== B.isActive() && B.toggle(n),
                K.setState(e));
            }
          }
          function Lt() {
              ...
              (n
                ...
                : i
                  ...
                  : r
                    ? (O = parseInt(r, 10))
                    : ((O = f.autoSlide),
                      y.querySelectorAll(`.fragment`).length === 0 &&
                        t(y, `video, audio`).forEach((e) => {
                          e.hasAttribute(`data-autoplay`) &&
                            O &&
                            (e.duration * 1e3) / e.playbackRate > O &&
                            (O = (e.duration * 1e3) / e.playbackRate + 1e3);
                        })),
                O &&
                  !j &&
                  !lt() &&
                  !B.isActive() &&
                  (!at() || z.availableRoutes().next || f.loop === !0) &&
                  ((A = setTimeout(() => {
          ...
          function Vt({ skipFragments: e = !1 } = {}) {
            ...
            f.rtl
              ? (B.isActive() || e || z.next() === !1) &&
                Q().left &&
                Z(h + 1, f.navigationMode === `grid` ? _ : void 0)
              : (B.isActive() || e || z.prev() === !1) &&
                Q().left &&
                Z(h - 1, f.navigationMode === `grid` ? _ : void 0);
          }
          ...
          function Gt({ skipFragments: e = !1 } = {}) {
            ...
            if (e || z.prev() === !1)
              if (Q().up)
                ...
                if (
                  ((n = f.rtl
                    ? t(D.wrapper, w + `.future`).pop()
                    : t(D.wrapper, w + `.past`).pop()),
          ...
          function Kt({ skipFragments: e = !1 } = {}) {
            if (((b.hasNavigatedHorizontally = !0), (b.hasNavigatedVertically = !0), L.isActive()))
              return L.next();
            if (e || z.next() === !1) {
              let t = Q();
              (t.down && t.right && f.loop && rt() && (t.down = !1),
                t.down
                  ? Wt({
                      skipFragments: e,
                    })
          ...
          function Jt(e) {
            ...
            if (
              ...
              t.charAt(0) === `{` &&
              t.charAt(t.length - 1) === `}` &&
              ((t = JSON.parse(t)), t.method && typeof l[t.method] == `function`)
            )
          ...
          function $t(e) {
            (document.fullscreenElement || document.webkitFullscreenElement) === D.wrapper &&
        ...
        return (
          (B.initialize = (e) => {
            ...
            if (!(t instanceof HTMLElement))
              throw Error(`Unable to find presentation root (<div class="reveal">).`);
    ...
    __ds_ns.__errors.push({
      path: 'integrations/revealjs/vendor/reveal.js',
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
   ...
   OS prefers-reduced-motion; explicit choice wins (school-managed devices). */
    ...
    __ds_ns.__errors.push({ path: 'oak-theme.js', error: String((e && e.message) || e) });
  }
...
`;
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  ['video', 'quiz', 'worksheet', 'slide-deck'].map((i) =>
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                'Find lessons, units and resources for the subject you teach.',
              ),
            ),
            React.createElement(
              Button,
        ...
        return React.createElement(
          'a',
          {
            ...
            style: {
              ...
              boxShadow: hover
                ? inkShadow('var(--border-solid-xxl)')
                : inkShadow('var(--border-solid-xl)'),
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              "I'll draft a 50-minute lesson on tectonic hazards for Year 10. Want a starter quiz included?",
            ),
            React.createElement(
              'div',
              {
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                'New lessons, curriculum updates and teaching tips — about once a month. No spam, ever.',
              ),
            ),
            React.createElement(
              'div',
  ...
  try {
        ...
        return React.createElement(
          'span',
          {
            style: {
              ...
              border:
                color === 'white'
                  ? 'var(--border-solid-s) solid var(--border-primary)'
                  : 'var(--tag-border)',
                ...
                React.createElement(
                  'a',
                  {
                    ...
                    style: {
                      ...
                      borderBottom:
                        active === it
                          ? 'var(--border-solid-xl) solid var(--color-accent)'
                          : 'var(--border-solid-xl) solid transparent',
                    },
                  },
                  it,
                ),
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'div',
              null,
              '© 2026 Oak National Academy Limited. Resources on an open licence (OGL v3.0).',
            ),
    ...
    __ds_ns.__errors.push({ path: 'ui_kits/oak/shared.js', error: String((e && e.message) || e) });
  }
