...
export function finderPrompt(window: PartitionWindow, gazetteer: Gazetteer): string {
  ...
  return [
    ...
    '  1. STATUS / AUTHORIZATION LANGUAGE — a workflow, gate, PR, or task state word or marker (done, complete, merged, pending, blocked, ratified, 🟢/🟡/🔴, DISCHARGED, DECISION-COMPLETE, …) asserted about a named subject. -> factClass: status-assertion.',
