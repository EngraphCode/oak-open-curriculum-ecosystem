...
export function usage(): string {
  return [
    ...
    'minting a fresh PDR-027 session seed for the session that will occupy it, and',
    'emits a seat brief (the derived worktree/branch/identity plus any supplied',
    'role/task/Director) that invokes /oak-start-right-team.',
