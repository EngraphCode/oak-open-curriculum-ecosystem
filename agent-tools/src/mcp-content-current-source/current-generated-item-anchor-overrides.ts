...
export const CURRENT_GENERATED_ITEM_ANCHOR_OVERRIDES = {
  ...
  // MCP-462: upstream's 2026-07 rework changed the limit example 20 → 10.
  C519: {
    [LESSONS]: [
      String.raw`"default":20,"examples":[10]}},"additionalProperties":false,"required":["keyStage","subject"]}\nRequired: keyStage, subject`,
    ],
  },
  C527: {
    [KEY_STAGE_QUESTIONS]: [
  ...
  C529: {
    [KEY_STAGE_QUESTIONS]: [
      '"default":20,"examples":[10]},"filter":{"type":"string","description":"Optional filter for question results.',
      String.raw`\nRequired: keyStage, subject`,
    ],
  },
  C584: {
  ...
  // MCP-462: upstream's 2026-07 rework fixed the "Use the this type" typo.
  C586: {
    [PROGRAMME_ASSETS]: [
      '"default":20,"examples":[20]},"type":{"type":"string","description":"Use this type',
      String.raw`\nRequired: programme`,
    ],
  },
  C593: {
  ...
  // MCP-462: upstream's 2026-07 rework changed the limit example 20 → 100.
  C626: {
    [SEQUENCE_QUESTIONS]: [
      '"default":20,"examples":[100]},"filter":{"type":"string","description":"Optional filter for question results.',
      String.raw`\nRequired: sequence`,
    ],
  },
} as const;
