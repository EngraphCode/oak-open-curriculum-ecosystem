# Agent comms protocol (basic, n=3)

A minimal multi-agent collaboration protocol for this repository. It is a
deliberately small adaptation of the
...
The channel is [`comms-log.md`](./comms-log.md): a single **append-only** file.
