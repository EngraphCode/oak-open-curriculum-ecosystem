...
local [provider/consumer comparison](../../../../packages/research-evidence/scripts/openapi-oce-contract-comparison.ts)
proves exact structural equality only for two pinned snapshots; it does not prove
