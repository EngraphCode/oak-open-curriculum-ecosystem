...
Both source checkouts remain read-only. Research records, repeatable
inventories, fixtures and experiments belong in `web-app-deconstruction`.

## OCE workflows adopted
