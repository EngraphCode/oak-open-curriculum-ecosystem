...
Plan A (`embed-widget-html-at-build-time.plan.md` (`../../../plans-old-archive/sdk-and-mcp-enhancements/archive/completed/embed-widget-html-at-build-time.plan.md`)) is **COMPLETE** (ADR-156). This exploration confirmed:
