...
| OOC API wishlist | `ooc-api-wishlist/` (archived) | Reference / triage | Preserve as downstream consumer evidence. Validate against the current `oak-openapi` implementation before promoting any item as current work. |
...
| EEF Toolkit evidence | [eef/](eef/) | Dedicated subthread | EEF Teaching and Learning Toolkit data, strategic brief, technical comparison, and queued MCP surface plan. |
| External education skills + future KG sources | [../exploring-open-education-resources/external-knowledge-sources/](../exploring-open-education-resources/external-knowledge-sources/) | Source-ingestion lane | Covers education skills (CC BY-SA), and the meta-strategy for future third-party knowledge graphs as application data sources. |
