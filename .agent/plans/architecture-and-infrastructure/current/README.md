...
| P0B | [design-system-integration.plan.md](./design-system-integration.plan.md) | Integrate the Oak design system as a first-class workspace (Claude Design as a first-class team surface), extend the contrast gate to four themes, converge hub + token pipeline (ADR-213, AIP-137) | Executing (PR1–PR3 cycles 1–2 merged; ADR-213 Accepted 2026-07-20; cycle 3, dtcg↔CSS consistency check, and follow-on lanes open) |
...
| P6 | [test-purity-quick-wins-execution.plan.md](./test-purity-quick-wins-execution.plan.md) | Owner-commissioned test-purity quick-wins set (suffix invariants, vitest config purity, CI relocation) rescued 2026-07-20 from the private sibling Resonance estate | IMPORTED, PENDING ADAPTATION — source-estate facts must be re-derived against this tree before execution |
