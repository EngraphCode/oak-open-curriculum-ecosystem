...
| P0B | [design-system-integration.plan.md](./design-system-integration.plan.md) | Integrate the Oak design system as a first-class workspace (Claude Design as a first-class team surface), extend the contrast gate to four themes, converge hub + token pipeline (ADR-213, AIP-137) | Executing (PR1 in flight, 2026-07-19) |
