...
| [arc-colour-statusline-infrastructure.plan.md](arc-colour-statusline-infrastructure.plan.md) | Bring castr's ARC channel-grammar-derived truecolor feather badges + the repo-title usage relocation into oak agent-tools as one coherent estate: canonical channel grammar (`src/arc/`), palette + truecolor ANSI, `arcChannels[]` session shape, per-channel feather rendering, colour-assignment reporter CLI, corpus validator, in-place repair of the tracked rapid-comms corpus, and the extended channel-open convention. ADR-214 leads. Owner direction 2026-07-20; no backwards compatibility. | IN EXECUTION — readiness folded 2026-07-20 (4/4 SOUND-WITH-AMENDMENTS); Deliverable A MERGED (PR #427); B cycles next (Herring herds Channel, 9d81e5) |
