...
### F-122 — no mechanical merge-ready check exists; "checks green" gets declared as "merge-ready" despite the loaded rule
...
### F-123 — a harness-timeout kill of `git commit` orphans the pre-commit hook chain as a whole-tree lint fleet
