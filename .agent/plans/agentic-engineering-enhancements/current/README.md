...
| [repo-continuity-curation.plan.md](repo-continuity-curation.plan.md) | Restore `repo-continuity.md` to its compact-active-state role (per-entry conserve-then-delete of finished session-narrative per continuity-practice §Disposition); carries the reusable curation runbook + lossless-verification recipe | APPLIED 2026-06-28 (575→308 lines; recurrence owned by [future/continuity-surface-drift-prevention](../future/continuity-surface-drift-prevention.plan.md)) |
