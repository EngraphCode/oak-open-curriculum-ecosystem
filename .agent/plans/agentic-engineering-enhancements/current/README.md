...
| [large-corpus-analysis-v3-extraction-grain.plan.md](large-corpus-analysis-v3-extraction-grain.plan.md) | v3 of the corpus-analysis method: prompt-only map/reduce grain fix to preserve mechanism specificity (the v2 REFINE residual), a cheap pre-spend probe, then a gated full rerun. Aggregation layer untouched. Successor to the DONE/SUPERSEDED `large-corpus-analysis-v2-implementation.plan.md` | REVIEWED — READY FOR EXECUTION (full rerun owner-gated) |
