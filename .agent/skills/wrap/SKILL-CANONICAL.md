...
description: >-
  ...
  safely / we are done here, and at any terminal or risky boundary; an
  ordinary finish-up-for-now expecting to resume soon is session-handoff's
  moment instead. Route by intent and context, never keywords; at a true
  end, when in doubt, wrap.
---
...
`wrap` skill (AIP-142; inter-practice exchange per PDR-125), which conserved
