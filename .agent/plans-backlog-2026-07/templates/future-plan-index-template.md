# Future Plans — [Collection Name]

Deferred strategic backlog for later milestones. These plans are intentionally
not ready to execute yet.

Promote an item to `current/` when its named trigger fires and the
executable scope is clear.
