...
| Ontology Repo Fresh-Perspective Review (`../../plans-old-archive/connecting-oak-resources/knowledge-graph-integration/archive/completed/ontology-repo-fresh-perspective-review.plan.md`) | Future short plan | Follow-on plan for an upstream-first re-read of the ontology repo that is not anchored only in semantic-search assumptions |
| Direct Ontology Use and Graph Serving Prototypes (`../../plans-old-archive/connecting-oak-resources/knowledge-graph-integration/archive/superseded/direct-ontology-use-and-graph-serving-prototypes.plan.md`) | Future strategic plan | Tests whether direct ontology use is enough before Neo4j or Stardog is justified for search-adjacent workloads |
...
|-------|------------------|---------------------|
| Search working with the ontology, with downstream graph serving as an earned option | [Elasticsearch, Neo4j, and Oak Ontology Synthesis](../connecting-oak-resources/knowledge-graph-integration/research/elasticsearch-neo4j-oak-ontology-synthesis.research.md) | ../../plans-old-archive/connecting-oak-resources/knowledge-graph-integration/archive/superseded/oak-ontology-graph-opportunities.strategy.md (`../../plans-old-archive/connecting-oak-resources/knowledge-graph-integration/archive/superseded/oak-ontology-graph-opportunities.strategy.md`) |
| Direct ontology use versus downstream graph-serving platforms | [RDF to Product: Neo4j and Stardog for Oak](../../research/kg-neo4j-stardog-product-creation/kg-neo4j-stardog-product-creation-clean.md) | Direct Ontology Use and Graph Serving Prototypes (`../../plans-old-archive/connecting-oak-resources/knowledge-graph-integration/archive/superseded/direct-ontology-use-and-graph-serving-prototypes.plan.md`) |
