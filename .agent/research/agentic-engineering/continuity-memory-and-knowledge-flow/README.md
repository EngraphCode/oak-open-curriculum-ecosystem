# Continuity, Memory, and Knowledge Flow

Use this lane for split-loop continuity doctrine, operational evidence, and
source material about how learning moves from session capture into stable
practice.
