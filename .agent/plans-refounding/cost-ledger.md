...
> the run-total band (§4), the operational halt list (§8 — THIS draft's H-numbering is
> the adopted one: it matches the implemented runners, e.g. `refound-inventory-model.ts`
> emits `H2 halt-and-inspect`; the canonical ledger carries it as H1–H9 with the cost
> backstop at H7 and F3 §5.4's design-era series mapped as feeder material), and the SP3
> evidence-labelling clause (§9). The draft's full text is in git history (established
> 2026-07-06, Stoat rides Gloaming).
