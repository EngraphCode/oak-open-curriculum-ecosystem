...
1. **The full-processing pass — ONLY ws1d BATCHES E-b7 + E-b8 REMAIN (everything else DONE:
   ws1c/e/f/g + E-b1 2026-07-03, Gust hunts Headwind, `6708fb8eb`→`d79b56c63`; E-b2..E-b6
   ...
   action-time enforcement — + `1d32ff917` + `fb29ff2ef` + `558f046af` + `0fd8e57a7` + the
   E-b6 commit).**
   Tier E ranks 151–187 (37 items, one ~25 batch + one 12 batch; jq: `.tierE[150:175]` of
   `.agent/reports/agentic-engineering/large-corpus-analysis-tooling/data/discovery-run-salvage-tiers-2026-07-02.json`
   for E-b7). The plan's ws1d todo carries drain state and the worked shape; the ws1g
