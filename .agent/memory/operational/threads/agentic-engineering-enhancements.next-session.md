...
1. **The full-processing pass — ONLY ws1d BATCHES E-b2..E-b8 REMAIN (everything else DONE
   2026-07-03, Gust hunts Headwind: ws1c + ws1e + ws1f + ws1d/E-b1 as `6708fb8eb`,
   `3d8781aac`, `ea9c16054`, `89208e0d2`; then ws1g same-seat owner-directed as `64f0fab51`,
   `2fbab3d15`, `a835f3c4b`, `d79b56c63`).** Tier E ranks 26–187 (162 items, ~25/batch, one
   commit per batch; jq: `.tierE[25:50]` of `data/discovery-run-salvage-tiers-2026-07-02.json`
   for E-b2). The plan's ws1d todo carries drain state and the E-b1 worked shape; the ws1g
   ...
   (`precedence-is-not-approval`). Fresh-seat opener (refreshed to the E-b2 pickup):
