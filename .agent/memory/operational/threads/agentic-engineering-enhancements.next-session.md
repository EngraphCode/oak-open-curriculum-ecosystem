...
1. **The full-processing pass — ONLY ws1d BATCHES E-b6..E-b8 REMAIN (everything else DONE:
   ws1c/e/f/g + E-b1 2026-07-03, Gust hunts Headwind, `6708fb8eb`→`d79b56c63`; E-b2..E-b5
   ...
   action-time enforcement — + `1d32ff917` + `fb29ff2ef` + `558f046af` + the E-b5 commit).**
   Tier E ranks 126–187 (62 items, ~25/batch, one commit per batch; jq: `.tierE[125:150]` of
   `.agent/reports/agentic-engineering/large-corpus-analysis-tooling/data/discovery-run-salvage-tiers-2026-07-02.json`
   for E-b6). The plan's ws1d todo carries drain state and the worked shape; the ws1g
