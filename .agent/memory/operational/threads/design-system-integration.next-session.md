...
1. **Recognisability criterion**: the Oak identity in this repo must be
   ...
   pupil experiences at <www.thenational.academy> AND
   labs.thenational.academy/aila. Carried in
...
ca6b0fd8f; estate rotated to coordination/2026-08-13-ca6b0f; my
directed request 266a3e74 thereby discharged; the fleet plan's stale
sanction-gate row was cured in the fold). Director froze again
post-rotation (their freeze 9; seat continues). Open owner gates
unchanged otherwise: S6845; #846 un-draft (F7 cure + explicit Copilot
re-request first).
