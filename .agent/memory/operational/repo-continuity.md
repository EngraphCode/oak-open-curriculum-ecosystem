...
| --- | --- | --- | --- |
| `neo-curriculum-vault-research` | Public-source analysis of NEO Curriculum Vault value, mechanics, intent, Oak relationship, and potential mutual support; report complete and independently reviewable against its explicit contract, with review and landing pending | [record](threads/neo-curriculum-vault-research.next-session.md) | codex / GPT-5 / Parsec binds Heavens / analyst, synthesist, team closeout owner / 2026-07-14 (three specialist explorers: thread record) |
