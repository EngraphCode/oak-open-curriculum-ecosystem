...
- **Operating model: SOLO, no Director seat** (owner direction 2026-06-25). Worktree-pilot CLOSED OUT,
  ...
  merge-ready (Alder tracks Topsoil 2026-06-26: contain-first + `@oaknational/safe-path` SSOT; Phase 2 regex next); the
