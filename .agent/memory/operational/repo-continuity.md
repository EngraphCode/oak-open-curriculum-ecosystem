...
**The work queue** (each self-contained): (1) AIP-126 — restatement-audit
boundary hardening, 8-item spec in the Linear ticket, TDD, small atomic PR;
(2) AIP-128/129/130 — the enforcement tranche, specs in the tickets; (3) the
