...
>
> **SEATED-BLOCK NOTES 2026-07-30 ~08:55Z (at owner-directed compaction prep — the seat CONTINUES post-compaction; continuation record claim-addressed under handoffs/). Durable half only; recompute every derivable (Squall's command block below stays canonical). Rulings 1–20 (Lynx) + Bora's tenure additions (guarded scoped mint; event-driven cadence; fix-first) REMAIN BINDING by reference.**
>
