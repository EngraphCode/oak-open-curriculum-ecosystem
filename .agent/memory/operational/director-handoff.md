...
>
> **§COMPACTION FREEZE 9, 2026-08-13 ~09:3xZ** (owner word "prepare for compaction … then stop all processes", mid-fold): claims `a2286c53` + `dd3f640f` RETAINED; ALL PROCESSES STOPPED BY INTENT (stop-loop-first held); the seat CONTINUES at resume; branch `coordination/2026-08-12-219095` — the fold to main is IN FLIGHT.
>
