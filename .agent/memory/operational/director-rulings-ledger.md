...
| SKILLS-FIRST | skills lane completes FIRST, through evals on every Practice skill — verbatim: "finish the skill work first, including getting to the point where all Practice skills have evals" (2026-08-17, direct to Director) | owner-verbatim | task #10 + skills-estate-organisation plan (WS8 evals general + pilot convention → estate-wide); sequences AHEAD of the profanity-filter work |
