...
| Tally-at-PR-open entry contract (retrospective 2026-08-24 proposal 2, registered via proposal 4): opening or adopting a bot-reviewed PR creates the round-tally artefact before first triage — a constitutional change to how the estate reviews. Worked warrant: three no-tally arcs (PR #390, PR #570, the 2026-08-24 harness arc) where the step-back trigger existed and nothing counted. Provenance: `.agent/reports/agentic-engineering/why-the-outage-outlived-its-six-character-fix-2026-08-24.md` §Proposals | By review: the entry contract has landed in pr-lifecycle AND every bot-reviewed PR arc opened after that landing carries a tally built at open (both observable from the repo and PR record on the day; decidable with no holding state) | Contract not landed by review — killed with that reasoning, re-registerable through the normal process; or a post-landing bot-reviewed arc runs tally-less | 2026-10-24 |
