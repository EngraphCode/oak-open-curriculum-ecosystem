...
| [`owner-working-style.md`](owner-working-style.md) | Durable owner identity assertions — how the owner approaches engineering decisions | Interpreting owner silence, reframes, or pauses |
| [`owner-signal-interpretation.md`](owner-signal-interpretation.md) | Channel semantics for owner direction — hedges, demonstrated actions, supersession vs extension, session-scoped defaults | Weighing whether an owner turn is a grant, a gate, a supersession, or thinking aloud |
