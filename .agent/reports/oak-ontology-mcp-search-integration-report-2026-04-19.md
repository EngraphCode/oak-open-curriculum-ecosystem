...
| [nc-knowledge-taxonomy-surface.plan.md](../plans-backlog-2026-07/connecting-oak-resources/knowledge-graph-integration/future/nc-knowledge-taxonomy-surface.plan.md) | First safe MCP ontology slice | Still valid, but too narrow to stand alone as "the ontology integration plan" |
