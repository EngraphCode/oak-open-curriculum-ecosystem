...
- [ADR-225: Adopt provider-independent capability composition for runtime services](225-provider-independent-capability-contracts.md)
...
- **[ADR-225](225-provider-independent-capability-contracts.md)** - Adopt provider-independent capability composition: runtime-adapter placement, PostgreSQL/Neon separation, and an exercised independent composition for every selected provider
