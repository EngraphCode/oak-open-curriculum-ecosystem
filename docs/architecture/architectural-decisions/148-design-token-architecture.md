...
[ADR-213](213-design-system-integration-and-component-architecture.md) (2026-07-19; ADR-213
accepted 2026-07-20, so the supersession is now in force — the §Source Format source-of-truth
direction only: the integrated design system's CSS becomes the token source and DTCG JSON
becomes a generated projection of it; the three-tier model, contrast gate, and CSS delivery
format stand)
**Date**: 2026-04-02
