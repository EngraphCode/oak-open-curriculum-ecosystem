...
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | --------------------------------------------------- |
| Curriculum-model truth    | C286–C305 contain the assembled model: notably ontology content C287–C304 and its composition into the resource at C305   | curriculum expert                                        | content unit and assembled `curriculum://model`     |
