        ...
        {modules.map((module, index) => (
          ...
          >
            <span className="flex items-center gap-[11px] p-[16px_18px_10px]">
              <span
                aria-hidden="true"
                className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border-2 border-oak-black bg-white text-[15px] leading-none font-bold"
              >
                {index + 1}
              </span>
              <span className="flex-1">
                <span className="block text-lg leading-[23px] font-bold">{module.title}</span>
                <span className="mt-[3px] block text-[13px] leading-none font-light text-oak-grey">
            ...
            <span className="mt-auto block p-[14px_18px_16px]">
              <a
                href={`#${module.id}`}
                className="shadow-oak-lemon flex w-full items-center justify-center gap-[7px] rounded-lg border-2 border-oak-black bg-oak-black p-[11px] text-sm leading-none font-bold text-white no-underline"
              >
