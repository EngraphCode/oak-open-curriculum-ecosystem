...
function LinkedStandardCard(): ReactElement {
  return (
    <div className="rounded-xl border-2 border-oak-lavender bg-oak-lavender-subdued p-4">
      <div className="mb-2 flex items-center gap-2 text-[11px] font-bold uppercase tracking-wide text-oak-navy">
        <svg
          width="14"
          height="14"
          viewBox="0 0 24 24"
      ...
      <div className="mb-1 text-[15px] font-semibold leading-snug text-oak-black">
        Writing questions for checks for understanding
      </div>
      <span className="text-[13px] font-bold text-oak-navy">
...
export default function ContentLinks(): ReactElement {
  return (
    <section className="mx-auto max-w-[1080px] px-6 pb-16">
      <div className="grid overflow-hidden rounded-2xl border-2 border-oak-black md:grid-cols-[1.4fr_1fr]">
        <div className="bg-oak-lavender-subdued p-8">
          <div className="mb-3 text-[12px] font-bold uppercase tracking-[0.06em] text-oak-grey">
            Everything&rsquo;s connected
          </div>
          <h2 className="mb-4 text-[26px] font-semibold leading-tight text-oak-black">
            Content that links to itself
          </h2>
          <p className="mb-3 max-w-[46ch] text-[15px] leading-relaxed text-oak-black">
          ...
          <p className="max-w-[46ch] text-[15px] leading-relaxed text-oak-black">
            Update a standard once, and every page that references it stays in step. One source of
            truth, joined up.
          </p>
        </div>
        <div className="border-t-2 border-oak-black bg-white p-8 md:border-l-2 md:border-t-0">
          <div className="mb-3 text-[13px] text-oak-grey">
            In a training page, you&rsquo;ll see:
          </div>
          <LinkedStandardCard />
          <p className="mt-4 text-[13px] leading-relaxed text-oak-grey">
