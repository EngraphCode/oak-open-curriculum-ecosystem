...
const ARROW_BUTTON =
  'flex h-6 w-7 items-center justify-center rounded-md border-2 border-line bg-surface text-[11px] aria-disabled:opacity-40';

/** One surface-role row: the item text plus its stacked ▲▼ move buttons. */
function SortableRow({
  ...
  return (
    <li className="flex items-center gap-3 rounded-[10px] border-2 border-line bg-surface p-[11px_13px]">
 ...
 * pill + arrow hint, surface-role rows with stacked ▲▼ buttons, and the black
