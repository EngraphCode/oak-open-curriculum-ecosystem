          ...
          <button
            ...
            className={`rounded-full border-2 border-line px-3.5 py-2 text-[13px] font-bold ${
              chip.active
                ...
                : 'bg-surface text-ink hover:shadow-accent-brand'
            }`}
          >
            {chip.label}
          </button>
  ...
  return (
    <div className="mb-[18px] flex flex-wrap items-center gap-3.5 rounded-large border-2 border-line bg-info-subtle px-[18px] py-3.5">
      ...
      <button
        type="button"
        onClick={() => onBrowseAll()}
        className="shrink-0 rounded-full border-2 border-link bg-surface px-4 py-2 text-[13px] font-bold text-link"
      >
      ...
      <div className="mb-2 flex flex-wrap items-center gap-4">
        ...
        {view.hasFilters && (
          <button
            type="button"
            onClick={() => onReset()}
            className="rounded-full border-2 border-line bg-surface px-3.5 py-1.5 text-[13px] font-semibold shadow-accent-brand"
          >
            Reset filters
          </button>
        )}
  ...
  return (
    <div className="mt-[22px] flex items-center justify-center gap-3">
      ...
      <button
        type="button"
        onClick={() => onShowAll()}
        className="rounded-full border-2 border-line bg-surface px-[22px] py-3 text-[15px] font-bold text-ink"
      >
