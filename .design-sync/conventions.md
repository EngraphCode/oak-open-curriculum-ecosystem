...
| Type     | `oak-heading-1`…`oak-heading-7`, `oak-heading-light-1`…`-4`, `oak-body-1`…`oak-body-4` (+ `-bold`), `oak-code-2`, `oak-prose`                                                                                                                                                                                 |
...
| Misc     | `oak-table`, `oak-accordion`, `oak-icon` (`--mask`), `oak-skeleton`, `oak-empty`, `oak-visually-hidden`, `oak-block`, `oak-block-label`                                                                                                                                                                       |
...
them from the stylesheet before use.
